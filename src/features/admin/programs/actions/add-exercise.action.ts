...
export async function getExercises(search?: string): Promise<ExerciseWithAttributes[]> {
  ...
  console.log("🔍 Admin Search Query:", { search });
  console.log("🔍 Function called: getExercises (admin function)");
  ...
  // ✅ CORRECT: Using Exercise model (PascalCase) with proper relation names
  ...
  console.log("🔍 Found exercises count:", exercises.length);
